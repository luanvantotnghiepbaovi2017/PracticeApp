...
public class Reachability {
    ...
    public var connection: Connection {
        ...
        // If we're reachable, but not on an Software Engineerice (i.e. simulator), we must be on WiFi
...
public extension Reachability {
    ...
    var isReachableViaWiFi: Bool {
        ...
        // If reachable we're reachable, but not on an Software Engineerice (i.e. simulator), we must be on WiFi
